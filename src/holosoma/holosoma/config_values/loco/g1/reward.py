...
g1_29dof_loco = RewardManagerCfg(
    ...
    terms={
        ...
        "penalty_contact_state_switching": RewardTermCfg(
            func="holosoma.managers.reward.terms.locomotion:PenaltyContactStateSwitching",
            weight=-1.0,
            params={"min_steps_between_switches": 3, "penalty_per_changed_foot": False},
            tags=["penalty_curriculum"],
        ),
...
g1_29dof_loco_fast_sac = RewardManagerCfg(
    ...
    terms={
        ...
        # "penalty_com_height": RewardTermCfg(
        #     func="holosoma.managers.reward.terms.locomotion:penalty_com_height",
        #     weight=-5.0,
        #     params={"reference_com_height": 0.8, "terrain_relative": True},
        #     tags=["penalty_curriculum"],
        # ),
        # "penalty_contact_state_switching": RewardTermCfg(
        #     func="holosoma.managers.reward.terms.locomotion:PenaltyContactStateSwitching",
