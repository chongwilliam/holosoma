...
g1_29dof_fast_sac = ExperimentConfig(
    ...
    robot=replace(
        robot.g1_29dof_dual_stance,
        actions_dim=action.G1_WBC_TASK_SPACE_ACTION_DIM,
        control=replace(
            robot.g1_29dof_dual_stance.control,
            action_scale=action.G1_WBC_TASK_SPACE_ACTION_SCALE,
            action_clip_value=action.G1_WBC_TASK_SPACE_ACTION_CLIP,
        ),
    ),
    # terrain=terrain.terrain_locomotion_mix,
    terrain=terrain.terrain_locomotion_plane,
    observation=observation.g1_29dof_loco_single_wolinvel,
    action=action.g1_29dof_torque,
    termination=termination.g1_29dof_termination,
    randomization=randomization.g1_29dof_randomization_dual_stance_reset,
    command=command.g1_29dof_command,
