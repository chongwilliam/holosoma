...
from holosoma.config_values.loco.g1.randomization import (
    g1_29dof_randomization,
    g1_29dof_randomization_dual_stance_reset,
)
...
DEFAULTS = {
    ...
    "g1_29dof_dual_stance_reset": g1_29dof_randomization_dual_stance_reset,
